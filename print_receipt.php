...
where " . dbObject . "EMP.WebCode = '" . $_SESSION['code'] . "' ");
                            ...
                            <div class="mb-3 overflow-hidden">
                                <button type="button" class="btn btn-success btn-actions float-end submit-next enBtn" onclick="printInvoice()">Submit <i class="fa fa-arrow-right icon-font"></i></button>
