...
where " . dbObject . "EMP.WebCode = '" . $_SESSION['code'] . "' ");
								...
								<div class="mb-3 overflow-hidden">
									...
									<button type="button" class="btn btn-danger btn-actions float-end submit-next enBtn" onClick="loadPage('list_sales_voucher.php')">Clear</button>
									<button type="button" class="btn btn-danger btn-actions float-end submit-next arBtn" onClick="loadPage('list_sales_voucher.php')"><?= getArabicTitle('Clear') ?></button>
...
where " . dbObject . "EMP.WebCode = '" . $_SESSION['code'] . "' ");
								...
								$rf = Run("Select count(Billno) as totalrec from dataout   $condition");
								...
								$OrderBy = "Order by dataout.Billno DESC";

								$qpt = "Select * from dataout $condition  $OrderBy " . $pages->limit . "";
								$result = Run($qpt);
								?>
								<div class="mb-3">
									<!-- Listing -->
			...
			<div class="modal-content">
				...
				<form action="javascript:sendemailform()">
					<div class="modal-body">
						<label>Email</label>
						<input type="email" name="email" id="email" placeholder="Enter Email" class="form-control direction" required>
						<input type="hidden" name="bill_id" id="bill_id">
						<input type="hidden" name="b_id" id="b_id">

						<label class="mt-2">Language</label>
						<select class="form-control direction " id="email_lang" name="email_lang">
							<option value="1">English</option>
							<option value="2">Arabic</option>
						</select>
					</div>
