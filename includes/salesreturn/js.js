...
$.ajax({
url:"includes/salesreturn/saveSalesForm.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
if (unit_id == '') {
$('#unit_id').siblings(".select2-container").css('border', '2px solid red');
anyaction = true;
} else {
$('#unit_id').siblings(".select2-container").css('border', '1px solid green');
}
...
if (Pcode != '') {
$.post("includes/salesreturn/addRow.php", {
Pcode: Pcode,
product: product,
unit_id: unit_id,
unit: unit,
...
$.post("includes/salesreturn/fetchProductDetails.php",{
code:vvl,
Bid:Bid,
Uid:Uid	
},function(data){
...
$.post("includes/salesreturn/fetchProductDetailsFromCode.php",{
code:vvl,
Bid:Bid,
Uid:Uid	
},function(data){
...
$.post("includes/salesreturn/getProductList.php",{
code:vvl,
},function(data){
...
$.post("includes/salesreturn/loadBanks.php",{
code:vvl,
},function(data){
...
if(vatPer!='0')
{
$.post("includes/salesreturn/Pricecalculations.php",{
vvl:vvl,
tp:tp,
vatPer:vatPer,
vatAmt:vatAmt,
...
if(vatPer!='0')
{
$.post("includes/salesreturn/PricecalculationsRow.php",{
vvl:vvl,
tp:tp,
vatPer:vatPer,
vatAmt:vatAmt,
...
$.post("includes/salesreturn/saveFinalStep.php",{
SBBillno:SBBillno,
Bid:Bid,
},function(data){
...
$.post("includes/salesreturn/printInvoice.php",{
Bid:Bid,
Billno:Billno,
...
{
document.getElementById('printInvoice').innerHTML = "<img width='80px' src='loader/wheel.gif'/>";	
$.post("includes/salesreturn/print.php",{
Bid:Bid,
Billno:Billno,
LanguageId:LanguageId,
},function(data){
...
{
	var Bid = $('#Bid').val();
document.getElementById('CheckSaleBill').innerHTML = "<img width='80px' src='loader/wheel.gif'/>";	
$.post("includes/salesreturn/CheckSaleBill.php",{
Bid:Bid,
Billno:sale_bill_no,
...
function loadAllSectionsForSalesReturn(Bid,Billno,sBid,LanguageId)
{
...
{
document.getElementById('sale_bill_no_area').innerHTML = "<img width='80px' src='loader/wheel.gif'/>";	
$.post("includes/salesreturn/sections/sale_bill_no_area.php",{
Bid:Bid,
Billno:Billno,
sBid:sBid,
LanguageId:LanguageId,
...
{
document.getElementById('product_add_addRow').innerHTML = "<img width='80px' src='loader/wheel.gif'/>";	
$.post("includes/salesreturn/sections/product_add_addRow.php",{
Bid:Bid,
Billno:Billno,
sBid:sBid,
LanguageId:LanguageId,
},function(data){
$("#product_add_addRow").html(data);
});		
}
...
$.post("includes/salesreturn/sections/bank_section.php",{
Bid:Bid,
Billno:Billno,
sBid:sBid,
LanguageId:LanguageId,
...
function sendemailform()
{
	...
	$.post("includes/salesreturn/send_email.php",{
		b_id:b_id,
		bill_id:bill_id,
		LanguageId:LanguageId,
		email:email,
...
window.open(
'includes/salesreturn/print.php?Billno='+bill_id+'&Bid='+b_id+'&LanguageId='+print_language+'',
...
{
var Bid = $("#Bid").val();
document.getElementById('loadUnits').innerHTML ="<img width='80px' src='loader/wheel.gif'/>";

$.post("includes/salesreturn/fetchProductUnits.php",{
code:vvl,
Bid:Bid
},function(data){
$("#loadUnits").html(data);});
...
var Bid = $("#Bid").val();
document.getElementById('fetchProductDetails').innerHTML ="<img width='80px' src='loader/wheel.gif'/>";
$.post("includes/salesreturn/LoadUnitPrice.php",{
code:vvl,
Bid:Bid,
Uid:Uid	
},function(data){
