...
?>
	...
	<div class="content_form">
		...
		<div class="mb-3">
			<a href="includes/sales/print.php?Billno=<?= $Billno ?>&Bid=<?= $Bid ?>&LanguageId=<?= $LanguageId ?>" target="_blank" class="btn btn-light p-3 enBtn" style="display:<?= $enDisplay?>;">
				<span class="icons_d"><i class="fa fa-whatsapp" aria-hidden="true"></i></span>
				Whatsapp</a>

			<a href="includes/sales/print.php?Billno=<?= $Billno ?>&Bid=<?= $Bid ?>&LanguageId=<?= $LanguageId ?>" target="_blank" class="btn btn-light p-3 arBtn"  style="display:<?= $arDisplay; ?>;">
