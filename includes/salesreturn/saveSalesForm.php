...
$currentRow = $CSID.",''".$RefNo1."'',".$Pid.",".$Uid.",''".$ppc."'',".$qty.",".$QtyInLowQty.",".$Price.",".$Total.",".$Discount.",".$NetTotal.",".$vatPer.",".$vatAmt.",".$vatTotal.",".$vatPTotal.",".$VatPrice.",".$CPrice.",".$cpt.",".$ppriceDet.",".$spriceDet.",".$autono;	
...
$FvatTotal = $FvatTotal-$FvatTotalv;
  ...
  $saleSp = "exec ".dbObject."InsertSaleReturnWeb
@Bid=$Bid
,@CSID=$CSID
,@SPType=$SPType
,@Total=$FTOtal
...
// $filename = $PNG_TEMP_DIR.'SaleReturn-'.$SBBillno.'-'.$_SESSION['companyId'].'.png';
// QRcode::png(($ddd), $filename, $errorCorrectionLevel, $matrixPointSize, 2); 

// Mobile Side Save
//// Generate QR Code////

$PNG_WEB_DIR = '../../../Mtech/vouchers/salesreturn/QrCodes/';
$PNG_TEMP_DIR = '../../../Mtech/vouchers/salesreturn/QrCodes/';
