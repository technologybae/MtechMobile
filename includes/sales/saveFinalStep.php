...
<div class="content_form">
	...
	<div class="mb-3">
		<a href="javascript:openPrintPopup('<?= $Billno ?>','<?= $Bid ?>');" class="btn btn-light p-3 enBtn" style="background-color: #34465d; display:<?= $enDisplay?>;">
			<span class="icons_d"><i class="fa fa-whatsapp" aria-hidden="true"></i></span>
			Whatsapp</a>

		<a href="javascript:openPrintPopup('<?= $Billno ?>','<?= $Bid ?>');" class="btn btn-light p-3 arBtn"  style="display:<?= $arDisplay; ?>;">
