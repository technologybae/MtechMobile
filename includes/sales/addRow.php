...
$CostPrice = addslashes($_POST['CostPrice']);
$costTotal = addslashes($_POST['costTotal']);
...
<div class="mb-3 card p-4 direction" id="<?php echo $row_count ?>">
	<h5 class="enBtn"><?php echo $Pcode ?>-<?php echo $product ?></h5>
	<h5 class="arBtn"><?php echo $product ?>-<?php echo $Pcode ?></h5>
	<ul>
		<li>
		...
		<li>
			...
			<input type="hidden" name="CostPrice<?php echo $row_count ?>" class="t_CostPrice" id="CostPrice<?php echo $row_count ?>" value="<?php echo $CostPrice ?>">
		    <input type="hidden" name="costTotal<?php echo $row_count ?>" class="t_costTotal" id="costTotal<?php echo $row_count ?>" value="<?php echo $costTotal ?>">
		</li>
