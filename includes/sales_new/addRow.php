...
//	let GenericHtml = '';
//	GenericHtml = '<tr id="<?=$row_count?>"><td><?=$row_count?><td><?php echo $Pcode ?>-<?php echo $product ?></td><td><?php echo $unit ?></td><td><?php echo $qty ?></td><td><?php echo $Sprice ?></td><td><?php echo $Sprice*$qty ?></td><td><?php echo $vatSprice ?></td></tr>'; 
//	
//	console.log(GenericHtml);
//	document.getElementById("NewRows").innerHTML += GenericHtml;
//
//GenericHtml = '';
