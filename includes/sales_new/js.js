...
$.ajax({
url:"includes/sales_new/saveSalesForm.php",
data: fd,
cache: false,
processData: false,
contentType: false,
...
if (parseFloat(qty) > parseFloat(openStock)) {
...
if (Pcode != '') {
$.post("includes/sales_new/addRow.php", {
Pcode: Pcode,
product: product,
unit_id: unit_id,
unit: unit,
...
///////////////// Apend NewHtml///////////
var GenericHtml = '<tr id="NewRow'+row_count+'"><td>'+product+' ('+unit+')</td><td>'+qty+'</td><td>'+Sprice+'</td></tr>'; 	
	$("#NewRows").append(GenericHtml);
...
$.post("includes/sales_new/fetchProductDetails.php",{
code:vvl,
Bid:Bid,
Uid:Uid	
},function(data){
...
$.post("includes/sales_new/fetchProductUnits.php",{
code:vvl,
Bid:Bid
},function(data){
$("#loadUnits").html(data);});
...
var Bid = $("#Bid").val();
document.getElementById('fetchProductDetails').innerHTML ="<img width='80px' src='loader/wheel.gif'/>";
$.post("includes/sales_new/LoadUnitPrice.php",{
code:vvl,
Bid:Bid,
Uid:Uid	
},function(data){
...
$.post("includes/sales_new/fetchProductDetailsFromCode.php",{
code:vvl,
Bid:Bid,
Uid:Uid	
},function(data){
...
$.post("includes/sales_new/getProductList.php",{
code:vvl,
},function(data){
...
$.post("includes/sales_new/loadBanks.php",{
code:vvl,
},function(data){
...
if(vatPer!='0')
{
$.post("includes/sales_new/Pricecalculations.php",{
vvl:vvl,
tp:tp,
vatPer:vatPer,
vatAmt:vatAmt,
...
if(vatPer!='0')
{
$.post("includes/sales_new/PricecalculationsRow.php",{
vvl:vvl,
tp:tp,
vatPer:vatPer,
vatAmt:vatAmt,
...
$.post("includes/sales_new/saveFinalStep.php",{
SBBillno:SBBillno,
Bid:Bid,
},function(data){
...
$.post("includes/sales_new/printInvoice.php",{
Bid:Bid,
Billno:Billno,
...
{
document.getElementById('printInvoice').innerHTML = "<img width='80px' src='loader/wheel.gif'/>";	
$.post("includes/sales_new/print.php",{
Bid:Bid,
Billno:Billno,
LanguageId:LanguageId,
},function(data){
...
window.open(
'includes/sales_new/print.php?Billno='+bill_id+'&Bid='+b_id+'&LanguageId='+print_language+'',
...
$.post("includes/sales_new/send_email.php",{
b_id:b_id,
bill_id:bill_id,
LanguageId:LanguageId,
email:email,
