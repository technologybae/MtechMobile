...
//		$this->ipp_array = array(10,25,50,100,150,200,'All');
...

	{
	 ...
	 //$this->limit = (isset($_GET['ipp']) && $_GET['ipp'] == 'All') ? "":" @FRecNo=$this->low,@ToRecNo=$this->items_per_page";
...

	{
		...
		return "<div class='col'><strong class='text-danger'>Total: ".number_format($this->items_total)."</strong></div></div></div></div>\n";
