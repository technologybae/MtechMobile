 ...
 *
 */
$config['APIUsername'] = $config['Sandbox'] ? 'gujjarg89-facilitator_api1.gmail.com' : 'PRODUCTION_USERNAME_GOES_HERE';
$config['APIPassword'] = $config['Sandbox'] ? 'EAKYSV7G7H7VV58V' : 'PRODUCTION_PASSWORD_GOES_HERE';
$config['APISignature'] = $config['Sandbox'] ? 'AFcWxV21C7fd0v3bYYYRCpSSRl31ALdNQelQSi6Gn2CFfCcuZldxXqum' : 'PRODUCTION_SIGNATURE_GOES_HERE';
 ...
 */
$config['ApplicationID'] = $config['Sandbox'] ? SITE_NAME : 'PRODUCTION_APP_ID_GOES_HERE';
