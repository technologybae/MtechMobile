...
<![endif]-->
                                                                    ...
                                                                    <!--<table align="left" width="100%" border="0" cellpadding="0" cellspacing="0" class="mcnImageContentContainer" style="min-width:100%;">
                                                                        <tbody><tr>
                                                                                <td class="mcnImageContent" valign="top" style="padding-right: 9px; padding-left: 9px; padding-top: 0; padding-bottom: 0; text-align:center;">
                                                                                    ...
                                                                                    <img align="center" alt="" src="<?php // echo base_url() ?>assets/site/img/header.jpg" style="max-width:100%; padding-bottom: 0; display: inline !important; vertical-align: bottom;" class="mcnImage">
   ...
   <?php $userData = getUserByID($order->user_id); ?>                                                                                               <span style="font-size:12px;float:left;width:100%;"><?php echo ucwords($order->full_name);?></span>
   <span style="font-size:12px;float:left;width:100%;"><?php echo $userData->email; ?></span>
   <span style="font-size:12px;float:left;width:100%;"><?php echo $userData->address; ?>, <?php echo $userData->zip; ?>, <?php echo $userData->city; ?>, <?php echo $userData->country_id; ?></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody></table>
                                                                                    ...
                                                                                    <table width="100%" border="1" cellspacing="0" cellpadding="10" style="font-size:12px;">
                                                                                        <tbody>
																							...
																							<?php //print_r($orderItem);?>
                                                                                                ...
                                                                                                <td><?php echo $orderItem['p_name']; ?></td>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                    ...
                                                                                    <strong>THANK YOU FOR YOUR PURCHASE!</strong><br>
                                                                                        <span style="color: #222222;font-family: verdana,sans-serif;font-size: 11.3333px;line-height: normal;">If you have any questions concerning this invoice, please contact us. E-mail:<?php echo getSiteSettings('sales_email'); ?></span><br>
																							...
																							<?php if($ourAddress) { ?>
	<span style="color: #222222;font-family: verdana,sans-serif;font-size: 11.3333px;line-height: normal;"><?php echo $ourAddress; ?></span>																						<?php } ?>
                                                                                            </td>
                                                                                            </tr>
                                                                                            </tbody></table>
