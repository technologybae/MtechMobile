                                                                    ...
                                                                    <table align="right" border="0" cellpadding="0" cellspacing="0" width="197" class="mcnTextContentContainer">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right:18px; padding-bottom:9px; padding-left:18px;">
                                                                                    ...
                                                                                    <a href="*|ARCHIVE|*" style="line-height: 20.8px;" target="_blank"><?php echo getSiteSettings('sales_email'); ?></a><a href="mailto:<?php echo getSiteSettings('sales_email'); ?>" style="line-height: 20.8px;" target="_blank">&nbsp;</a>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody></table>
