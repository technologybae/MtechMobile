            ...
            <meta http-equiv="X-UA-Compatible" content="IE=edge">
                <meta name="viewport" content="width=device-width, initial-scale=1">
                    ...
                    <body>
                        <center>
                            <?php
				$emailData = getEmailContentDataByType('Pay Order');
                                                                    ...
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                    ...
                                                                                    <strong>Your Invoice at <?php echo SITE_NAME; ?></strong>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody></table>
                                                                                    ...
                                                                                    <tbody><tr>
                                                                                            ...
                                                                                            <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                                ...
                                                                                                <span style="font-size:13px"><strong>Date: </strong></span><span style="font-size:12px"><?php echo displayDateFormat($order->order_date); ?></span><br>
                                                                                                    <span style="font-size:13px"><strong>Order:</strong> </span><span style="font-size:12px"><?php echo $order->order_id; ?></span><br>
																									<span style="font-size:13px"><strong>Order Total:</strong> </span><span style="font-size:12px">$<?php echo setPriceFormat($order->total_amount, 2);?></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody></table>
                                                                                    ...
                                                                                    <tbody><tr>
                                                                                            ...
                                                                                            <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                                ...
                                                                                                <strong>Bill To: </strong><br>
                                                                                                    <span style="font-size:12px"><?php echo ucwords($order->full_name);?></span><br>
																									<span style="font-size:12px">Email:<?php echo $order->email;?></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody></table>
...
<?php echo $email_body; ?>
                                                                        ...
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                    ...
                                                                                    <table width="100%" border="1" cellspacing="0" cellpadding="10" style="font-size:12px;">
                                                                                        <tbody>
                                                                                            <tr>
                                                                                                <td width="5%" align="center" valign="middle" bgcolor="#EFEFEF"><strong>Sr</strong></td>
                                                                                                <td bgcolor="#EFEFEF" width="30%"><strong>Description</strong></td>
                                                                                                <td width="15%" align="center" valign="middle" bgcolor="#EFEFEF"><strong>License Keys</strong></td>
																								<td width="15%" align="center" valign="middle" bgcolor="#EFEFEF"><strong>Single Key Activations</strong></td>
																								<td width="15%" align="center" valign="middle" bgcolor="#EFEFEF"><strong>Unit Price</strong></td>
                                                                                                <td width="20%" align="center" valign="middle" bgcolor="#EFEFEF"><strong>Price</strong></td>
                                                                                            </tr>
                                                                                            <?php
																							//print_r($orderHistory);
                                                                                                    ...
                                                                                                    foreach ($orderHistory as $orderItem) {
																										...
																										$license_activations = 2;
																										if($orderItem['subscription_plan'] == 'custom')
																										{
																											$license_activations = $orderItem['serial_key'];
																										}
																										elseif($orderItem['subscription_plan'] == 'trainer')
																										{
																											$license_activations = 25;
																										}
																										elseif($orderItem['subscription_plan'] == 'corporate')
																										{
																											$license_activations = 10;
																										}
 ...
 Subscription Period: <strong><?php echo $orderItem['subscription']; ?> Months</strong> - Subscription Package: <strong><?php echo ucwords($orderItem['subscription_plan']); ?></strong>
																								...
																								<td align="center" valign="middle"><?php echo $license_activations; ?></td>
                                                                                            ...
                                                                                            <tr>
                                                                                                <td colspan="5" align="right">TAX RATE</td>
                                                                                                <td align="center" valign="middle">0.00%</td>
                                                                                            </tr>
                                                                                            <tr>
                                                                                                <td colspan="5" align="right">SALES TAX</td>
                                                    ...
                                                    ?></strong></td>
																							...
																							<tr>
																								...
																								<a target="_blank" style="background: blue;color: #fff;text-decoration: none;padding: 10px 20px;float: right;text-align: center;font-size: 18px;text-transform: uppercase;border-radius: 5px;" href="<?php echo base_url(); ?>payments/payorder/<?php echo $order->order_id; ?>">Complete Order</a>
																								</td>
                                                                                            </tr>
