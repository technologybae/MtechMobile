                                                                    ...
                                                                    <table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                                                                        <tbody><tr>
                                                                                ...
                                                                                <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
																					...
																					<p>You recieved an order from <?php echo SITE_NAME; ?></p>
                                                                                </td>
                                                                            </tr>
                                                                        </tbody></table>
																			...
																			<table align="left" border="0" cellpadding="0" cellspacing="0" width="100%" style="min-width:100%;" class="mcnTextContentContainer">
                                                                                    <tbody><tr>
                                                                                            ...
                                                                                            <td valign="top" class="mcnTextContent" style="padding-top:9px; padding-right: 18px; padding-bottom: 9px; padding-left: 18px;">
                                                                                                ...
                                                                                                <span style="font-size:13px"><strong>Customer Name: </strong></span><span style="font-size:12px"><?php echo ucwords($order->full_name);?></span><br>
                                                                                                <span style="font-size:13px"><strong>Customer Email:</strong> </span><span style="font-size:12px"><?php echo $order->email;?></span>
                                                                                            </td>
                                                                                        </tr>
                                                                                    </tbody></table>
