    ...
    <form id="sales_voucher">
        <section>
            ...
            <div class="slide-form justify-content-center">
                    ...
                    <div class="content_form">
                        <div class="form_list">
                            ...
                            <!-- <div class="mb-3 overflow-hidden">
                                <button type="button" class="btn btn-info btn-actions float-start back text-white" onclick="loadPage('salesreturn_voucher_type.php');"><i class="fa fa-arrow-left icon-font"></i>&nbsp;Back</button>
                            ...
                            <div class="mb-3 overflow-hidden">
								<button type="button" class="btn btn-info btn-actions float-start back text-white enBtn" onclick="loadPage('salesreturn_voucher_type.php');"><i class="fa fa-arrow-left icon-font"></i>&nbsp;Back</button>
								<button type="button" class="btn btn-info btn-actions float-start back text-white arBtn" onclick="loadPage('salesreturn_voucher_type.php');"><?= getArabicTitle('Back') ?><i class="fa fa-arrow-left icon-font"></i></button>
								...
								<button type="button" class="btn btn-success btn-actions float-end submit-next arBtn" onclick="next(this);loadBanks(Bid.value)"><i class="fa fa-arrow-right icon-font"></i> <?= getArabicTitle('Next') ?></button>
							</div>
                        </div>
                    </div>
                    <div class="m-5"></div>
                ...
                <div class="slide-box slided glass direction" id="sale_bill_option">
                    <div class="content">
                        <h2 class="heading_fixed enBtn">Sales Return Voucher</h2>
						<h2 class="heading_fixed arBtn"><?= getArabicTitle('Sales Return Voucher') ?></h2>
                    </div>
                    <div class="content_form">
                        <div class="form_list">
                            ...
                            <div class="row mb-3">
                                <!-- <label for="" class="form-label">Sale Bill </label> -->
                                <label for="" class="form-label"><span class="en">Sale Bill</span><span class="ar"> <?= getArabicTitle('Sale Bill') ?></span></label>
                                <div class="mb-3 col-6">

                                    <div class="form-check">
                                        <input class="form-check-input sale_bill" onClick="checkSpBillNo()" checked type="radio" name="sale_bill" id="Yes" value="Yes">
                                        <label class="form-check-label" for="Yes">
											<span class="en">Yes</span>
											<span class="ar"><?= getArabicTitle('Yes') ?></span>
										</label>
                                    </div>
                                </div>
                                <div class="mb-3 col-6">
                                    <div class="form-check">
                                        <input class="form-check-input sale_bill" type="radio" name="sale_bill" id="No" onClick="checkSpBillNo()" value="No">
                                        <label class="form-check-label" for="No">
											<span class="en">No</span>
											<span class="ar"><?= getArabicTitle('No') ?></span>
                                        </label>
                                    </div>
                                </div>
                            </div>
                            <div class="mb-3" id="checkSpBillNo">
                                <!-- <label for="" class="form-label">Sale Bill no </label> -->
                                <label for="" class="form-label"><span class="en">Sale Bill No</span><span class="ar"> <?= getArabicTitle('Sale Bill No') ?></span></label>
                            ...
                            <div class="mb-3 overflow-hidden">
                                ...
                                <button type="button" class="btn btn-success btn-actions float-end submit-next enBtn" onclick="validateSaleNo(this)">Next <i class="fa fa-arrow-right icon-font"></i></button>
								<button type="button" class="btn btn-success btn-actions float-end submit-next arBtn" onclick="validateSaleNo(this)"><i class="fa fa-arrow-left icon-font"></i> <?= getArabicTitle('Next') ?></button>
                            </div>
                        </div>
                    </div>
                    <div class="m-5"></div>
                ...
                <div class="slide-box slided glass direction" id="sale_bill_no_area">
                    <div class="content">
                        <h2 class="heading_fixed enBtn">Sales Return Voucher</h2>
						<h2 class="heading_fixed arBtn"><?= getArabicTitle('Sales Return Voucher') ?></h2>
                    </div>
                    <div class="content_form">
                        <div class="form_list">
                            ...
                            <div class="mb-3">
                                ...
                                <input type="number" class="form-control direction" name="RefNo1" id="RefNo1" readonly>
                            </div>
                            <div class="mb-3">
                ...
                <div class="slide-box slided glass direction" id="product_add_section">
                    <div class="content">
                        <h2 class="heading_fixed enBtn">Sales Return Voucher</h2>
						<h2 class="heading_fixed arBtn"><?= getArabicTitle('Sales Return Voucher') ?></h2>
                    ...
                    <div class="content_form">
                        <div class="form_list">
                            ...
                            <!-- <div class="mb-3 overflow-hidden">
                                <button type="button" class="btn btn-info btn-actions float-start back text-white" onclick="prev(this);"><i class="fa fa-arrow-left icon-font"></i>&nbsp;Back</button>
                                <button type="button" class="btn btn-success btn-actions float-end submit-next" onclick="generateRow(this)">Next <i class="fa fa-arrow-right icon-font"></i></button>
                            </div> -->
                            ...
                            <div class="mb-3 overflow-hidden">
								...
								<button type="button" class="btn btn-success btn-actions submit-next float-end enBtn" onclick="generateRow(this)">Next <i class="fa fa-arrow-right icon-font"></i></button>
								<button type="button" class="btn btn-success btn-actions submit-next float-end arBtn" onclick="generateRow(this)"> <i class="fa fa-arrow-left icon-font"></i> <?= getArabicTitle('Next') ?></button>
							</div>
                        </div>
                    </div>
                ...
                <div class="slide-box slided glass direction" id="product_add_addRow">
                    <div class="content">
                        <h2 class="heading_fixed enBtn">Sales Return Voucher</h2>
						<h2 class="heading_fixed arBtn"><?= getArabicTitle('Sales Return Voucher') ?></h2>
                    </div>
                    <div class="content_form">
                        <div class="form_list">
                            ...
                            <div class="mb-3 overflow-hidden">
								...
								<button type="button" class="btn btn-info btn-actions float-start back text-white arBtn" onclick="addMoreRows(this);"><?= getArabicTitle('Add More') ?>&nbsp;<i class="fa fa-arrow-right icon-font"></i></button>
								...
								<button type="button" class="btn btn-success btn-actions float-end submit-next arBtn" onclick="calculateAllTotals(this)"><i class="fa fa-arrow-left"><?= getArabicTitle('Next') ?></i></button>
							</div>
                        </div>
                    </div>
                ...
                <div class="slide-box slided glass direction" id="totalsSection">
                    <div class="content">
                        <h2 class="heading_fixed enBtn">Sales Return Voucher</h2>
						<h2 class="heading_fixed arBtn"><?= getArabicTitle('Sales Return Voucher') ?></h2>
                    </div>
                    <div class="content_form">
                        <div class="form_list">
                            <div class="mb-3">
								...
								<label for="" class="form-label"><span class="en">Total : </span><span class="ar"><?= getArabicTitle('Total') ?> :</span><span id="span_total"></span></label><input type="hidden" id="total" name="total">
                            </div>
                            ...
                            <div class="mb-3 overflow-hidden">
								...
								<button type="button" class="btn btn-success btn-actions float-end submit-next arBtn" onclick="paymentScreen(this)"><i class="fa fa-arrow-left icon-font"></i> <?= getArabicTitle('Next') ?></button>
							</div>
                        </div>
                    </div>
                    <div class="m-5"></div>
                ...
                <div class="slide-box slided glass direction" id="bank_section">
                    <div class="content">
                        <h2 class="heading_fixed enBtn">Sales Return Voucher</h2>
						<h2 class="heading_fixed arBtn"><?= getArabicTitle('Sales Return Voucher') ?></h2>
                    </div>
                    <div class="content_form">
                        <div class="form_list">
                            ...
                            <div class="mb-3" style="display: none;">
								...
								<label for="" class="form-label"><span class="en">Remaining : </span><span class="ar"><?= getArabicTitle('Remaining') ?> :</span><span id="payment_screen_remaining"></span></label>
                            </div>
                            <div class="row mb-3">
                                <div class="mb-3 col-6">
                                    <div class="form-check">
                                ...
                                <div class="mb-3">
                                    ...
                                    <input type="text" name="CustomerName" id="CustomerName" class="form-control direction">
                            ...
                            <div class="mb-3 overflow-hidden">
								...
								<button type="button" class="btn btn-success btn-actions float-end submit-next arBtn" id="finishSave" onclick="customerValidation(this);"><i class="fa fa-arrow-left icon-font"></i> <?= getArabicTitle('Finish & Save') ?></button>
							</div>
                        </div>
                    </div>
                </div>
...
<script src="includes/salesreturn/js.js"></script>
