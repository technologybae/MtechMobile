...
//		$this->ipp_array = array(10,25,50,100,150,200,'All');
		...
		$this->ipp_array = array(10,25,50,100,150,200,500,1000,2000,4000);
...

	{
...

		{
			...
			$this->return .= ($_GET['page'] == 'All') ? "<li class='page-item active'><a class=\"page-link\" hidden href=\"javascript:;\"><span class=\"en\">All</span><span class=\"ar\"> ".getArabicTitle('All') ."</span></a></li> \n":"<li class='page-item'><a class=\"page-link\" hidden href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\"><span class=\"en\">All</span><span class=\"ar\"> ".getArabicTitle('All') ."</span></a></li></ul></div> \n";
...

		{
			...
			$this->return .= "<li class='page-item'><a class=\"page-link\" href=\"$_SERVER[PHP_SELF]?page=1&ipp=All$this->querystring\"><span class=\"en\">All</span><span class=\"ar\"> ".getArabicTitle('All') ."</span></a></li></ul></div> \n";
		...
		//$this->limit = (isset($_GET['ipp']) && $_GET['ipp'] == 'All') ? "":" OFFSET $this->low ROWS FETCH NEXT $this->items_per_page ROWS ONLY";
		
	$this->limit =  (isset($_GET['ipp']) && $_GET['ipp'] == 'All') 
		? "@FRecNo=$this->low,@ToRecNo=1000000"  :"@FRecNo=$this->low,@ToRecNo=$this->items_per_page";
...

	{
		...
		return "<div class='col-sm-5 float-sm-right'><div class='form-row mt-2 text-right'><div class='col'> <select class=\"border rounded text-muted arBtn\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select> <span class='en'>Rows:</span><span class='ar'>:".getArabicTitle('Rows') ."</span> <select class=\"border rounded text-muted enBtn\" onchange=\"window.location='$_SERVER[PHP_SELF]?page=1&ipp='+this[this.selectedIndex].value+'$this->querystring';return false\">$items</select></div>\n";
...

	{
		...
		// return "<div class='col'><span class=\"text-muted\">Page:</span> <select class=\"border rounded text-muted\" onchange=\"window.location='$_SERVER[PHP_SELF]?page='+this[this.selectedIndex].value+'&ipp=$this->items_per_page$this->querystring';return false\">$option</select></div><div class='col'><strong class='text-danger'>Total: ".$this->items_total."</strong></div></div></div></div>\n";
			...
			<strong class='text-danger enBtn'>Total:".number_format($this->items_total)."</strong>
			<strong class='text-danger arBtn'>".number_format($this->items_total)." :".getArabicTitle('Total') ."</strong>
			</div></div></div>
			</div>\n";
